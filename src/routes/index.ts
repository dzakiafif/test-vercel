...
export const ADMINROUTES = {
  ...
  PRODUCT_IMAGES_CREATE: '/admin/create-product-images',
  PRODUCT_IMAGES_LIST: '/admin/list-product-images',
  PRODUCT_IMAGES_UPDATE: `/admin/update-product-images/${RouteParams.Id}`,
  PRODUCT_IMAGES_DELETE: `/admin/delete-product-images/${RouteParams.Id}`,
